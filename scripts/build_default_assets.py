...
Note: Uses xiaozhi-fonts component from original Xiaozhi project
(https://github.com/78/xiaozhi-esp32) for font and emoji rendering.
...
def get_text_font_path(builtin_text_font, xiaozhi_fonts_path):
    ...
    Note: Uses xiaozhi-fonts component from original Xiaozhi project
    (https://github.com/78/xiaozhi-esp32) for font rendering
...
def get_emoji_collection_path(default_emoji_collection, xiaozhi_fonts_path):
    ...
    Note: Uses xiaozhi-fonts component from original Xiaozhi project
    (https://github.com/78/xiaozhi-esp32) for emoji rendering
