...
private:
    ...
    WazoDeviceStatus WazoStatus_ = kDevice_Exit_Distributionnetwork;
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnEnterSleepMode([this]() {
            ...
            WazoStatus_ = kDevice_join_Sleep;
        ...
        power_save_timer_->OnExitSleepMode([this]() {
            ...
            if (WazoStatus_ != kDevice_Exit_Sleep) {
    ...
    void InitializeButtons() {
        ...
        middle_button_.OnPressUp([this]() {
            ...
            if (WazoStatus_ == kDevice_Distributionnetwork || WazoStatus_ == kDevice_Exit_Sleep) {
                esp_timer_stop(power_manager_->timer_handle_);
                gpio_set_level(CHG_CTRL_PIN, 0);
                vTaskDelay(pdMS_TO_TICKS(100));
                gpio_set_level(SYS_POW_PIN, 0);
                vTaskDelay(pdMS_TO_TICKS(100));
            } else if (WazoStatus_ == kDevice_join_Sleep) {
                GetBacklight()->RestoreBrightness();
                WazoStatus_ = kDevice_null;
            }
        });
