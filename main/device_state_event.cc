...
ESP_EVENT_DEFINE_BASE(WAZO_STATE_EVENTS);
...
void DeviceStateEventManager::PostStateChangeEvent(DeviceState previous_state, DeviceState current_state) {
    ...
    esp_event_post(WAZO_STATE_EVENTS, WAZO_STATE_CHANGED_EVENT, &event_data, sizeof(event_data), portMAX_DELAY);
}
...
DeviceStateEventManager::DeviceStateEventManager() {
    ...
    ESP_ERROR_CHECK(esp_event_handler_register(WAZO_STATE_EVENTS, WAZO_STATE_CHANGED_EVENT, 
...
DeviceStateEventManager::~DeviceStateEventManager() {
    esp_event_handler_unregister(WAZO_STATE_EVENTS, WAZO_STATE_CHANGED_EVENT, nullptr);
}